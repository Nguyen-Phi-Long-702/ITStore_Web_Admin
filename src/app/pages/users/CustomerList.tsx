              ...
              {filteredCustomers.map((customer) => (
                <TableRow key={customer.id}>
                  <TableCell className="font-medium text-blue-600">
                    {customer.customer_code || `KH${customer.id.toString().padStart(6, "0")}`}
                  </TableCell>
                  <TableCell>
                        ...
                        <img
                          ...
                          onError={(e) => {
                            ...
                            if (parent) {
                              ...
                              fallback.className = 'w-10 h-10 rounded-full bg-blue-100 flex items-center justify-center';
                              fallback.innerHTML = '<svg class="h-5 w-5 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg>';
